...
Active Appearance Model (AAM) \cite{RefWorks:95}, particularly the variation by
Baker and Matthews \cite{RefWorks:227} that relates AAMs to the Lucas-Kanade
\cite{RefWorks:71,RefWorks:10} optical flow literature. However, our method
