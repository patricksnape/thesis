...
\begin{figure*}
    ...
    \caption{Average frequency of convergence vs Point standard deviation for
             ...
             (\labelcref{fig:lk_results_nocorruption}) No Corruption
             (\labelcref{fig:lk_results_biasfield}) Simulated Bias Field
             (\labelcref{fig:lk_results_occlusion}) Occlusions
             (\labelcref{fig:lk_results_occlusion_biasfield}) Occlusions + Bias Field.
