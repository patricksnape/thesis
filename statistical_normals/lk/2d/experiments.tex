...
\begin{figure}
    ...
    \resizebox{\textwidth}{!}{%
    \begin{tabular}{cccc}
    Error & Depth & IP & SPHERICAL \\
    0.02                                                                                                         &
    \includegraphics[valign=m,scale=0.16]{statistical_normals/images/lk2d/aam_error_examples/depth_002_248}      &
    \includegraphics[valign=m,scale=0.16]{statistical_normals/images/lk2d/aam_error_examples/normals_002_334}    &
...
\begin{figure}
    ...
    \begin{tabular}{ccc}
    Initial & 5 & 10 \\
    \includegraphics[valign=m,scale=0.16]{statistical_normals/images/lk2d/fitting/fitting_1_0165} &
    \includegraphics[valign=m,scale=0.16]{statistical_normals/images/lk2d/fitting/fitting_5} &
...
As an illustration of the alignment process for an AAM is illustrated in
...
\begin{figure}
    ...
    Mean & PC 1 & PC 2 & PC 3 & \\
    \multirow{2}{*}{\includegraphics[valign=m,scale=0.05]{statistical_normals/images/lk2d/depth/depth_mean}} & \includegraphics[valign=m,scale=0.10]{statistical_normals/images/lk2d/depth/depth_1_p3} & \includegraphics[valign=m,scale=0.10]{statistical_normals/images/lk2d/depth/depth_2_p3} & \includegraphics[valign=m,scale=0.10]{statistical_normals/images/lk2d/depth/depth_3_p3} & $+3\sigma$ \\
     & \includegraphics[valign=m,scale=0.10]{statistical_normals/images/lk2d/depth/depth_1_m3} & \includegraphics[valign=m,scale=0.10]{statistical_normals/images/lk2d/depth/depth_2_m3} & \includegraphics[valign=m,scale=0.10]{statistical_normals/images/lk2d/depth/depth_3_m3} & $-3\sigma$
    \end{tabular}%
    }
...
\begin{figure}
    ...
    \begin{tabular}{cccccc}
    Mean & PC 1 & PC 2 & PC 3 & \\
    \multirow{3}{*}{\includegraphics[valign=m,scale=0.10]{statistical_normals/images/lk2d/normals/normals_mean}} & \includegraphics[valign=m,scale=0.16]{statistical_normals/images/lk2d/normals/normals_1_p3} & \includegraphics[valign=m,scale=0.16]{statistical_normals/images/lk2d/normals/normals_2_p3} & \includegraphics[valign=m,scale=0.16]{statistical_normals/images/lk2d/normals/normals_3_p3} & $+3\sigma$ \\
...
\begin{figure}
    ...
    \begin{tabular}{cccccc}
    Mean & PC 1 & PC 2 & PC 3 & \\
    \multirow{3}{*}{\includegraphics[valign=m,scale=0.06]{statistical_normals/images/lk2d/spherical/spherical_mean}} & \includegraphics[valign=m,scale=0.12]{statistical_normals/images/lk2d/spherical/spherical_1_p3} & \includegraphics[valign=m,scale=0.12]{statistical_normals/images/lk2d/spherical/spherical_2_p3} & \includegraphics[valign=m,scale=0.12]{statistical_normals/images/lk2d/spherical/spherical_3_p3} & $+3\sigma$ \\
     & \includegraphics[valign=m,scale=0.12]{statistical_normals/images/lk2d/spherical/spherical_1_m3} & \includegraphics[valign=m,scale=0.12]{statistical_normals/images/lk2d/spherical/spherical_2_m3} & \includegraphics[valign=m,scale=0.12]{statistical_normals/images/lk2d/spherical/spherical_3_m3} & $-3\sigma$
    \end{tabular}%
    }
    \caption{The PCA basis of appearance learnt from the
             FRGC v2~\cite{phillips2005overview} for the SPHERICAL feature.
             SPHERICAL has 4 feature channels defined by
             \cref{eq:normalised-spherical}.
             The top and bottom rows
             show the principal components for $\pm 3 \sigma$ respectively.}
\label{fig:single_img_2d_aam_appearance_spherical}
\end{figure}
\setlength{\tabcolsep}{6pt}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
