...
that may not be visible to traditional stereo methods due to effects
such as subsurface scattering. The most commonly employed surface recovery
...
can be seperated into two distinct categories: time-multiplexing~\cite{ma2007rapid,%
fyffe2011comprehensive,alexander2009digital,vonderPahlen:2014kg,zhu2012estimating,%
malzbender2006surface,wilson2010temporal,ghosh2011multiview} and
multi-spectral~\cite{hernandez2010self,brostow2011video,fyffe2011single}.
Time multiplexed PS involves taking multiple images, each under
...
suspended 1.5 metres away from the subejct is revolved at approximately
25 rpm, producing around 2048 output images. Both subsurface (diffuse) and specular data were
recovered using chromaticity analysis and the specular component was utilized
to allow relighting from novel viewpoints. This work focused on the recovery
of reflectance information for image relighting and
required approximately one minute for capture, making
it impractical for dynamic use. \citet{weyrich2006analysis} provided a more
...
using a fiber optic spectrometer~\cite{nickell2000anisotropy} and provide
a model built from 149 subjects that is diverse across race, age and gender.
Both of these methods focused used a structured light method to recover
...
relighting. To improve the performance of multi-illumination time multiplexed
...
the simple separation of diffuse and specular normals by polarizing the 
gradients. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
