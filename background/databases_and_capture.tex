...
\begin{figure*}[ht]
	...
	\begin{subfigure}[b]{0.16\textwidth}
		...
		\caption{\footnotesize Basel~\cite{paysan20093d}}\label{fig:db_examples_basel}
	\end{subfigure}
	\begin{subfigure}[b]{0.16\textwidth}
		\centering
		\includegraphics[height=1.2in]{background/images/bu3d}
		\caption{\footnotesize BU3D-FE~\cite{Yin:2006cc}}\label{fig:db_examples_bu3d}
	\end{subfigure}
	\begin{subfigure}[b]{0.16\textwidth}
		\centering
		\includegraphics[height=1.2in]{background/images/bp4d}
		\caption{\footnotesize BP4D-S~\cite{Zhang:2014id}}\label{fig:db_examples_bp4d}
	\end{subfigure}
	\begin{subfigure}[b]{0.16\textwidth}
		\centering
		\includegraphics[height=1.2in]{background/images/frgc}
		\caption{\footnotesize FRGC v2~\cite{phillips2005overview}}\label{fig:db_examples_frgc}
	\end{subfigure}
	\begin{subfigure}[b]{0.16\textwidth}
		\centering
		\includegraphics[height=1.2in]{background/images/biwi}
		\caption{\footnotesize BIWI~\cite{fanelli2013random}}\label{fig:db_examples_biwi}
	\end{subfigure}
	\begin{subfigure}[b]{0.17\textwidth}
		\centering
		\includegraphics[height=1.15in]{background/images/ict}
		\caption{\footnotesize ICT-3DRFE~\cite{stratou2012exploring}}\label{fig:db_examples_ict}
	\end{subfigure}
