...
YaleB                       &\cite{georghiades2001fromfew}  &                       & 10          & 5760        & $\checkmark$ &              & PS     \\ \midrule
...
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%TODO: Add timeline of capture methods - makes it easier
%      for Stefanos to check if anything is missing.
