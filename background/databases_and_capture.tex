...
The CANDIDE~\cite{Rydfalk:1987tg,Ahlberg:1998uk} models were parameterizable
...
model was not captured from real data and thus had limited uses for modeling
...
requires careful modeling of the interaction between human skin and light. To
...
static scans and the performance capture is parameterized between the given
