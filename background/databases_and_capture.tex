...
% TODO: From the puppeteer.bib - all the methods that concentrate on 
% performance capture but not using models.
% \textbf{Hybrid Methods.} Although many of the \textit{active illumination}
% methods discussed above were technically hybrid methods, as they augmented
% a coarse model captured through structured light or passive stereo with
% photometric normals, they all proposed a novel illumination methodology. 
% However, there have been a number of hybrid methods, mostly involving
% combining passive stereo with photometric normals, where the major focuses of
% the works are algorithmic methods for achieving stereo and photometric fusion.
