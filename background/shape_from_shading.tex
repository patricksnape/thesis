...
Differential Equations. Similarly, \citet{papadhimitri2013new} demonstrated
that by swapping the orthographic camera assumption for a perspective
camera, causing the problem to become less constrained, provides a
well-posed and unique solution to the SfS problem. However, although it is
